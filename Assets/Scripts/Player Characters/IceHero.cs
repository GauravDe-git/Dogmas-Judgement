...
public class IceHero : MonoBehaviour
{
    [SerializeField] private float moveSpeed;
    [SerializeField] private float jumpSpeed;
    [SerializeField] private GameObject iceBallPrefab;
    [SerializeField] private Transform iceballPos;
    
    [Header("Audio")]
    [SerializeField] private AudioClip iceBallSFX;
    ...
    private IEnumerator FireBallAttack()
    {
        ...
        {
            AudioSource.PlayClipAtPoint(iceBallSFX,Camera.main.transform.position,1f);
            _animator.SetBool("isAttacking", true);
            yield return new WaitForSeconds(0.7f);
            Instantiate(iceBallPrefab, iceballPos.position, transform.rotation);
